...
public class Message implements Serializable {
    ...
    int MsgNo;     // Vector clock associated with the message
    ...
    public Message(String Msg)
    {
        ...
        this.MsgNo = Integer.parseInt(SplitMsg[2]);;
    ...
    public String ObjtoString()
    {
        ...
        String MsgStr =  "" + this.NodeId +"|"+ this.MsgSeq +"|"+ this.MsgNo;
    ...
    public void MsgPrint()
    {
        ...
        System.out.println("NodeId["+this.NodeId+"]  MsgSeq["+this.MsgSeq+"]   MsgNo["+this.MsgNo+"]");
    }
}
